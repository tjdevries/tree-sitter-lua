...
(program
 ...
 (function_statement (emmy_documentation (emmy_header))
  (function_start) (function_name (identifier) (table_dot) (identifier)) (function_body_paren) (function_body_paren)
...
(program
 ...
 (function_statement (emmy_documentation (emmy_header))
  (function_start) (function_name (identifier) (table_dot) (identifier)) (function_body_paren) (function_body_paren)
    (function_body (return_statement (number))) (function_end))
 (function_statement (emmy_documentation (emmy_header))
  (function_start) (function_name (identifier) (table_dot) (identifier)) (function_body_paren) (function_body_paren)
    (function_body (return_statement (number))) (function_end))
 (function_statement (emmy_documentation (emmy_header))
